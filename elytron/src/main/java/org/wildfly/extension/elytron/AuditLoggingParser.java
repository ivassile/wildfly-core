...
class AuditLoggingParser {
    ...
    private final PersistentResourceXMLDescription fileAuditLogParser_11_0 = builder(PathElement.pathElement(FILE_AUDIT_LOG), null)
        .setUseElementsForGroups(false)
    ...
    private final PersistentResourceXMLDescription periodicRotatingFileAuditLogParser_11_0 = builder(PathElement.pathElement(PERIODIC_ROTATING_FILE_AUDIT_LOG), null)
        .setUseElementsForGroups(false)
    ...
    private final PersistentResourceXMLDescription sizeRotatingFileAuditLogParser_11_0 = builder(PathElement.pathElement(SIZE_ROTATING_FILE_AUDIT_LOG), null)
        .setUseElementsForGroups(false)
    ...
    final PersistentResourceXMLDescription parser11_0 = decorator(ElytronDescriptionConstants.AUDIT_LOGGING)
        .addChild(aggregateSecurityEventParser)
        .addChild(customSecurityEventParser)
        .addChild(fileAuditLogParser_11_0)
        .addChild(periodicRotatingFileAuditLogParser_11_0)
        .addChild(sizeRotatingFileAuditLogParser_11_0)
        .addChild(syslogAuditLogParser_8_0)
        .build();
}
